...
namespace CFS.Assesment.Online.Business.Entities
{
    ...
    public abstract partial class ReferenceData : IReferenceData
    {
        ...
        public static Type[] GetAllTypes() => new Type[] 
            {
                typeof(CardinalPosition),
                typeof(RoverOperation),
                typeof(UserContext)
            };
        ...
        /// </summary>
        public abstract RefDataNamespace.CardinalPositionCollection CardinalPosition { get; }

        /// <summary> 
        /// Gets the <see cref="RefDataNamespace.RoverOperationCollection"/>.
        /// </summary>
        public abstract RefDataNamespace.RoverOperationCollection RoverOperation { get; }

        /// <summary> 
        /// Gets the <see cref="RefDataNamespace.UserContextCollection"/>.
        /// </summary>
        public abstract RefDataNamespace.UserContextCollection UserContext { get; }
