...
namespace CFS.Assesment.Online.Business.DataSvc
{
    ...
    public partial class ReferenceDataDataSvc : IReferenceDataDataSvc
    {
        ...
        public ReferenceDataDataSvc(IServiceProvider provider)
        {
            ...
            _cacheDict.Add(typeof(RefDataNamespace.CardinalPosition), new ReferenceDataCache<RefDataNamespace.CardinalPositionCollection, RefDataNamespace.CardinalPosition>(() => DataSvcInvoker.Current.InvokeAsync(typeof(ReferenceDataDataSvc), () => GetDataAsync(data => data.CardinalPositionGetAllAsync()))));
            _cacheDict.Add(typeof(RefDataNamespace.RoverOperation), new ReferenceDataCache<RefDataNamespace.RoverOperationCollection, RefDataNamespace.RoverOperation>(() => DataSvcInvoker.Current.InvokeAsync(typeof(ReferenceDataDataSvc), () => GetDataAsync(data => data.RoverOperationGetAllAsync()))));
            _cacheDict.Add(typeof(RefDataNamespace.UserContext), new ReferenceDataCache<RefDataNamespace.UserContextCollection, RefDataNamespace.UserContext>(() => DataSvcInvoker.Current.InvokeAsync(typeof(ReferenceDataDataSvc), () => GetDataAsync(data => data.UserContextGetAllAsync()))));
