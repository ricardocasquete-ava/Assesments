...
namespace CFS.Assesment.Online.Api
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddBeefDatabaseServices(() => new OnlineDb(WebApiStartup.GetConnectionString(_config, "Database")));
            ...
            services.AddAutoMapper(Beef.Mapper.AutoMapperProfile.Assembly, typeof(RoverControllerData).Assembly);
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "CFS.Assesment.Online API", Version = "v1" });
        ...
        public void Configure(IApplicationBuilder app, ILogger<WebApiExceptionHandlerMiddleware> logger)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CFS.Assesment.Online"));
